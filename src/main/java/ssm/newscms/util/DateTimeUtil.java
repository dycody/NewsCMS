...
public class DateTimeUtil {
	...
	private static final SimpleDateFormat MINUTE_FORMATER = new SimpleDateFormat(
			YYYY_MM_DD_HH_MM);
	...
	public static final String getStrDateMinute(Date date) {
	...
	public static final String getDateCharacterDate(Date date) {
		return DATE_CHARACTER_FORMATER.format(date);
	}

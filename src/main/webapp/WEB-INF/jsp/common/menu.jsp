      ...
      <!-- sidebar menu: : style can be found in sidebar.less -->
		...
		<ul class="sidebar-menu">
			...
			<li class="treeview"><a href="#"> <i class="fa fa-pie-chart"></i>
				...
				<ul class="treeview-menu">
					<li><a
						href="<c:url value="/resource/"/>pages/charts/chartjs.html"><i
							class="fa fa-circle-o"></i> ChartJS</a></li>
					<li><a
						href="<c:url value="/resource/"/>pages/charts/morris.html"><i
							class="fa fa-circle-o"></i> Morris</a></li>
					<li><a
						href="<c:url value="/resource/"/>pages/charts/flot.html"><i
							class="fa fa-circle-o"></i> Flot</a></li>
					<li><a
						href="<c:url value="/resource/"/>pages/charts/inline.html"><i
			...
			<li><a href="documentation/index.html"> <i
					class="fa fa-book"></i> <span>Documentation</span>
			</a></li>

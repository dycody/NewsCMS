...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<c:url value="/resource/"/>plugins/iCheck/flat/blue.css">
  <!-- Morris chart -->
  <link rel="stylesheet" href="<c:url value="/resource/"/>plugins/morris/morris.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="<c:url value="/resource/"/>plugins/jvectormap/jquery-jvectormap-1.2.2.css">
  <!-- Date Picker -->
  <link rel="stylesheet" href="<c:url value="/resource/"/>plugins/datepicker/datepicker3.css">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="<c:url value="/resource/"/>plugins/daterangepicker/daterangepicker.css">
  <!-- bootstrap wysihtml5 - text editor -->
  <link rel="stylesheet" href="<c:url value="/resource/"/>plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<c:url value="/resource/"/>dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<c:url value="/resource/"/>dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
              <!-- chat item -->
              <div class="item">
                <img src="<c:url value="/resource/"/>dist/img/user4-128x128.jpg" alt="user image" class="online">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="<c:url value="/resource/"/>dist/img/user3-128x128.jpg" alt="user image" class="offline">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="<c:url value="/resource/"/>dist/img/user2-160x160.jpg" alt="user image" class="offline">
...
<script src="<c:url value="/resource/"/>dist/js/pages/dashboard.js"></script>

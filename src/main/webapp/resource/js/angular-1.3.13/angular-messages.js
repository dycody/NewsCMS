 ...
 * `ngMessage` directives are demeetinged to handle the complexity, inheritance and priority
...
angular.module('ngMessages', [])
    ...
    *
    * @description
    * `ngMessages` is a directive that is demeetinged to show and hide messages based on the state

      ...
      angular.forEach(['minDate', 'maxDate', 'datepickerMode', 'initDate', 'shortcutPropagation'], function( key ) {
        if ( attrs[key] ) {
          ...
          if ( key === 'datepickerMode' ) {
            var setAttribute = getAttribute.asmeeting;
...
.controller('PaginationController', ['$scope', '$attrs', '$parse', function ($scope, $attrs, $parse) {
  var self = this,
      ngModelCtrl = { $setViewValue: angular.noop }, // nullModelCtrl
      setNumPages = $attrs.numPages ? $parse($attrs.numPages).asmeeting : angular.noop;
 ...
 */
  ...
  return {
    ...
    link:function (originalScope, element, attrs, modelCtrl) {
      ...
      var isLoadingSetter = $parse(attrs.typeaheadLoading).asmeeting || angular.noop;
      ...
      var $setModelValue = $parse(attrs.ngModel).asmeeting;
